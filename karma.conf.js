...
module.exports = function(config) {
  config.set({
    ...
    files: [
    "target/main/js/rbs-angular-http-lib.js",
    ...
    "target/main/js/rbs-angular-http.js",
    "target/test/unit/js/interceptor/CacheInterceptor_specs.js",
    "target/test/unit/js/interceptor/URLRewriterInterceptor_specs.js"
    ],
